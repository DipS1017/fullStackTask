...
exports.checkUsernameAvailability = exports.checkEmailAvailability = void 0;
...
var checkEmailAvailability = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var email, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!email || typeof email !== "string") {
                    return [2 /*return*/, next(new customError_1.ValidationError("Invalid or missing email parameter"))];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
var checkUsernameAvailability = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!userName || typeof userName !== "string") {
                    return [2 /*return*/, next(new customError_1.ValidationError("Invalid or missing username parameter"))];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
